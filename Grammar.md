...
```ebnf
symbol    Å® keyword | identifier
list      Å® "(" nil | function | operation ")"
nil       Å® É√
function  Å® identifier ( sexpr )?
operation Å® (operator | keyword) ( sexpr )?
```
...
```ebnf
operator Å® "+" | "-" | "*" | "/" | "<" | ">" | "="
keyword  Å® "define" | "set" | "cons" | "cond" | "car" | "cdr" | "and?" | "or?" | "not?" | "number?" | "symbol?" | "list?" | "nil?" | "eq?"
```